...
from pymongo import MongoClient, DESCENDING, ASCENDING, read_concern
...
def add_comment(movie_id, user, comment, date):
    ...
    comment_doc = {"text": comment, "date": date, "movie_id": ObjectId(movie_id), "name": user.name, "email": user.email}
...
def most_active_commenters():
    ...
    rc = read_concern.ReadConcern(level="majority")# you may want to change this read concern!
